            ...
            <td align="center" bgcolor="#e9ecef">
                ...
                <tr>
                    <td align="left" bgcolor="#1E1E1E" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0; color:whitesmoke;">An account has been created on your behalf.</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="left" bgcolor="#1E1E1E" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0; color:whitesmoke;">If you did not request a new account to be created, please contact us at servereserve@gmail.com</p>
                    </td>
                </tr>
                </table>
