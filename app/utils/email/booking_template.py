...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <td align="center" bgcolor="#1E1E1E">
        ...
        <tr>
            ...
            <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px; color:whitesmoke;">Your Booking</h1>
            </td>
        </tr>
        </table>
    ...
    <td align="center" bgcolor="#e9ecef">
        ...
        <tr>
            ...
            <p style="margin: 0; color:whitesmoke;">A booking has been made your behalf. The details are below.</p>
            </td>
        </tr>
