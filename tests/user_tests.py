        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"", "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':MAX_CHARS, "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
                self.assertIn('Invalid First Name, Please enter a first name between 3 - 150 characters in length', response.data.decode('utf-8'))
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"", "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":MAX_CHARS, "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
                self.assertIn('Invalid Surname, Please enter surname between 3 - 150 characters in length', response.data.decode('utf-8'))
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":MAX_CHARS, "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":MAX_CHARS, "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":"AAA", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
                self.assertIn('Invalid Street Address, Please enter Street Address no more than 150 characters in length', response.data.decode('utf-8'))
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":MAX_CHARS, "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":"AAA", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
                self.assertIn('Invalid Town Address, Please enter a town no more than 90 characters in length', response.data.decode('utf-8'))
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"sss", "phonenum":"07908548845", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"abcde", "hidden_email":"jbousfield92@outlook.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
        ...
        for role in self.roles:
            with app.test_request_context('/user/update_profile', method='POST', content_type='application/json'):
                with self.app.session_transaction() as sess:
                    ...
                    sess['username'] = VALID_USER['username']
                    sess['testing'] = True
                load = {'firstname':"Test", "lastname":"Tester", "housenum":"87", "street":"Test Street", "town":"Test Town", "postcode":"TE579ME", "phonenum":"07908548845", "hidden_email":"noemail.com"}
                response = self.app.post('/user/update_profile', data=load)
                self.assertEqual(response.status_code, 200)
